...
| Main deployment | Existing Amplify integration; build/check/test configuration and console fallback updated | Hosted preview job 6 passed at `1672c84` with Node 24.21.0/npm 12.0.2; production cutover pending |
